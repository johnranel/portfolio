        ...
        <main className="mx-auto max-w-screen-xl px-6 md:px-12 grid grid-flow-row lg:grid-cols-2 gap-5 relative">
            ...
            <section id="profile" className="lg:sticky lg:top-0 row-span-5 lg:max-h-screen pt-16 lg:pt-32">
                ...
                <div className="flex gap-5 mt-4 lg:mt-20">
                    <a href="https://github.com/johnranel" target="_blank" rel="noreferrer" className="block hover:text-slate-600">
                    ...
                    <a href="https://www.linkedin.com/in/john-ranel-dimaculangan-711239170/" target="_blank" rel="noreferrer" className="block hover:text-slate-600">
                ...
                <ul className="group/list text-xl font-maven tracking-tight">
                    <li className="mb-12">
                        <div className="group relative grid lg:grid-flow-col tansition-all lg:grid-cols-8 gap-2 lg:gap-4 hover:!opacity-100 group-hover/list:opacity-50">
                            ...
                            <figure className="lg:col-span-2">
                                <img src="/portfolio/resources/images/personal-website.png" alt="personal website preview" className="border-2 border-indigo-600/10 rounded-md" />
                    ...
                    <li className="mb-12">
                        <div className="group relative grid lg:grid-flow-col tansition-all lg:grid-cols-8 gap-2 lg:gap-4 hover:!opacity-100 group-hover/list:opacity-50">
                            <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition-all lg:-inset-x-6 lg:block lg:group-hover:bg-black/5"></div>
                            <figure className="lg:col-span-2">
                                <img src="/portfolio/resources/images/connect-eurobodalla.png" alt="connect eurobodalla website preview" className="border-2 border-indigo-600/10 rounded-md" />
                    ...
                    <li className="mb-12">
                        <div className="group relative grid lg:grid-flow-col tansition-all lg:grid-cols-8 gap-2 lg:gap-4 hover:!opacity-100 group-hover/list:opacity-50">
                            <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition-all lg:-inset-x-6 lg:block lg:group-hover:bg-black/5"></div>
                            <figure className="lg:col-span-2">
                                <img src="/portfolio/resources/images/cross-student-jobs.png" alt="cross student mobile application preview" className="border-2 border-indigo-600/10 rounded-md" />
                    ...
                    <li className="mb-12">
                        <div className="group relative grid lg:grid-flow-col tansition-all lg:grid-cols-8 gap-2 lg:gap-4 hover:!opacity-100 group-hover/list:opacity-50">
                            <div className="absolute -inset-x-4 -inset-y-4 z-0 hidden rounded-md transition-all lg:-inset-x-6 lg:block lg:group-hover:bg-black/5"></div>
                            <figure className="lg:col-span-2">
                                <img src="/portfolio/resources/images/online-store.png" alt="online store mobile application preview" className="border-2 border-indigo-600/10 rounded-md" />
